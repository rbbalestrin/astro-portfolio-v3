...
const presentation: Presentation = {
  ...
  description:
  "Hi there, I'm **Renan Bez** aka **themir**. I'm 19 y/o and I'm a CS undergrad student. I like **reading books** and **building things**. I enjoy **language design**, **web development** and I live on the terminal. Some of my favorite techs are **Rust**, **Svelte**, **Threejs**.",
  socials: [
    {
      label: "Linkedin",
